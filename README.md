# 📅 Phân Tích Lịch Giảng (TimeTable Analytics)

[![Version](https://img.shields.io/badge/version-0.011-blue.svg?style=flat-square)](https://github.com/your-username/your-repo-name)
...
- **Logic xử lý:**
    - Trích xuất Metadata (Tên GV, Học kỳ, Năm học).
